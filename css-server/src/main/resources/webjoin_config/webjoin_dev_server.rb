...
tomcat :csync_test do 
  ...
  webapp '/content-sync-system' do 
    ...
    # cms-db(common) config
    env[:common_jdbc_url]      = "jdbc:oracle:thin:@10.211.93.178:1521/STDB"
    env[:common_jdbc_username] = "mread"
    env[:common_jdbc_password] = "J3uOyS4H2q3wqD7eMkqyvw=="
    env[:common_jdbc_maxPoolSize] = 20
    
    # bks-db(book) config
    env[:book_jdbc_url]      = "jdbc:oracle:thin:@10.211.93.178:1521/STDB"
    env[:book_jdbc_username] = "bks"
    env[:book_jdbc_password] = "J3uOyS4H2q3wqD7eMkqyvw=="
    env[:book_jdbc_maxPoolSize] = 20
    
    # ccs-db(cartoon) config
    env[:cartoon_jdbc_url]      = "jdbc:oracle:thin:@10.211.93.178:1521/STDB"
    env[:cartoon_jdbc_username] = "COMIC"
    env[:cartoon_jdbc_password] = "J3uOyS4H2q3wqD7eMkqyvw=="
...
tomcat :csync_ops do 
  ...
  executor :shared, :min => 10, :max => 200
  connector :http, 9903, :executor => :shared, :URIEncoding => 'UTF-8'

  webapp '/content-sync-system' do 
    
    # cms-db(common) config
    env[:common_jdbc_url]      = "jdbc:oracle:thin:@10.211.95.53:1524:testdbd"
    env[:common_jdbc_username] = "mread"
    env[:common_jdbc_password] = "J3uOyS4H2q3wqD7eMkqyvw=="
    env[:common_jdbc_maxPoolSize] = 20
    
    # bks-db(book) config
    env[:book_jdbc_url]      = "jdbc:oracle:thin:@10.211.95.53:1524:testdbd"
    env[:book_jdbc_username] = "bks"
    env[:book_jdbc_password] = "J3uOyS4H2q3wqD7eMkqyvw=="
    env[:book_jdbc_maxPoolSize] = 20
