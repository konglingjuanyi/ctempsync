 ...
 *
 */
public class CartoonAdd implements TaskHandler {
	...
	private void mapCartoonToCommonAction(String bookID, OneToOneJobBuilder job) {
		...
		Action cartoonThumenailAction = BaseDMHelper.mapCartoonThumenailByBookID(bookID, job).diffSyncAction();
		...
		Action bookSeriesAction = BaseDMHelper.mapBookSeriesByBookid(bookID, job, null).diffSyncAction();
